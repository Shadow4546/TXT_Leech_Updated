...
photologo = 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRrcpI0KnMBl2ZrXEFsIcuaax1fbbpAXK5zHAi76gwBA-H6KeoIPcUy3eQV&s=10'
...
keyboard = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(text="📞 संपर्क", url="https://t.me/Lucifer_is_king_bot"),
            InlineKeyboardButton(text="🛠️ मदद", url="https://t.me/Lucifer_is_king_bot"),
        ],
    ]
)
...
async def start_command(bot: Client, message: Message):
    ...
    caption = (
        "🌟 स्वागतम {0}! 🌟\n\n"
        "➽ मैं एक शक्तिशाली TXT UPLOADER BOT हूं |📥\n\n➽ लिंक से वीडियो या फाइल निकलने के लिए भेजे(with https://)\n\n➽ .txt File से निकलने के लिए /aman का प्रयोग करें| 🗃️\n\n➽ रुकने के लिए /Stop use करें | ⛔ working process\n\n➽ /y2t का उपयोग YT Playlist into .txt के लिए करें। \n\n➽ /cookies से Youtube cookies update करें | .\n\n➽  /logs से Bot logs देखें।\n\n➽ 𝐌𝐚𝐝𝐞 𝐁𝐲: 🚩ᗅოꪖꫛ🚩"
    )
    ...
    await asyncio.sleep(1)
    await loading_message.edit_text(
        "Checking status Ok... \n**ᴊᴏɪɴ ᴏᴜʀ <a href='https://t.me/>टेलीग्राम समूह</a>**\n\n"
        "Progress:🟩🟩🟩🟩🟩🟩🟩🟩🟩 100%\n\n"
    )
...
async def send_logs(bot: Client, m: Message):
    try:
        with open("logs.txt", "rb") as file:
            sent= await m.reply_text("**📤 logs भेजा जा रहा है....**")
...
async def restart_handler(_, m):
    await m.reply_text("🚩रुक गया सरकार 🚩", True)
...
async def txt_handler(bot: Client, m: Message):
    editable = await m.reply_text(f"<pre><code>**🔹Hi मैं एक शक्तिशाली TXT UPLOADER BOT हूं.**</code></pre>\n<pre><code>🔹**मुझे TXT भेजो। .**</code></pre>")
